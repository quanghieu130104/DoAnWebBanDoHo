...
namespace DoAnWebBanDoHo.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Xác nhận email",
                        $"Vui lòng xác nhận tài khoản của bạn bằng <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>bấm vào đây</a>.");
        ...
        private IUserEmailStore<ApplicationUser> GetEmailStore()
        {
            ...
            {
                throw new NotSupportedException("UserManager không hỗ trợ email.");
            }
